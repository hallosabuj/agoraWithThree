...
var option = {
  ...
  channel: "MyChannel",
  uid: null,
  token: "006a8c2de6433de4f97af744dac4fb7ae39IADcLbUEl/xdHZnU4GmlTyaVvBYMfug4Ce42AAVu3EIhdeAS44oAAAAAEAAzuiAFVRhmXwEAAQBPGGZf"
}
  ...
  rtc.client.init(option.appID, function() {
    ...
    rtc.client.join(option.token ? option.token : null, option.channel, option.uid ? +option.uid : null, function(uid) {
      ...
      rtc.localStream.init(function() {
        ...
        rtc.localStream.play(rtc.viewDiv)
